...
import com.cuzoffservice.infrastructure.filter.JwtAuthenticationEntryPoint;
import com.cuzoffservice.infrastructure.filter.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests().antMatchers("/api/register","/api/authenticate").permitAll().
